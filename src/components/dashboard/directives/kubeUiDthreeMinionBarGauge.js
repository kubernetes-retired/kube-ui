angular.module('k8s.components.dashboard.directives').directive('kubeUiDthreeMinionBarGauge', function() {
  return {
    restrict: 'E',
    scope: {
      graphData: '=',
    ...
    link: function(scope, element, attrs) {
      element.addClass('concentricchart');
      ...
      var draw = function(d3) {
        ...
        scope.$watch(function() { return angular.element(window)[0].innerWidth; },
                     function() { return scope.render(scope.graphData); });
